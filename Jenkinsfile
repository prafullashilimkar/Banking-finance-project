pipeline {
  ...
  stages {
    ...
    stage('Deploy application using ansible'){
               steps {
                  ansiblePlaybook credentialsId: 'test-server', disableHostKeyChecking: true, installation: 'ansible', inventory: '/etc/ansible/hosts', playbook: '/var/lib/jenkins/workspace/Banking-project/my-serverfiles/finance-playbook.yml'  
                   }
            }
     }
}
